...
void Engine::Update(double deltaTime, GLFWwindow& window, GLuint shaderProgramID)
{
    ...
    ::g_inputHandler->HandleInput(&window);
...
void Engine::DrawObject(cMesh* pCurrentMesh, glm::mat4 matModelParent, GLuint shaderProgramID, double deltaTime)
{
    ...
    //GLint isMap = glGetUniformLocation(shaderProgramID, "isMap");
    //glUniform1f(isMap, (GLfloat)pCurrentMesh->isMap);
...
void Engine::BuildProject()
{
    ...
    WindowsUtils::CopyFolderContents(outDirPath, destinationPath);
}
