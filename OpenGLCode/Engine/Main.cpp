...
cCollisionMediator* g_CollisionMediator;
cStars* stars = nullptr;
...
//void DrawColliders(glm::mat4 matProjection, glm::mat4 matView, GLuint shaderProgramID);
...
int main(void)
{
    ...
    std::string windowTitle = "Galaga (1981)";
