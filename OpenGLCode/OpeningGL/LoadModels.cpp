...
//
//    pSpiderMan_body->adjustRotationAngleFromEuler( glm::vec3(-90.0f, 0.0f, 0.0f) );
////    pSpiderMan_body->adjustRotationAngleFromEuler( glm::vec3(0.0f, 0.0f, -90.0f) );
//
//
//
...
//{
//
//    std::vector<cMesh*> listOfCows = cGameManager::getGmInstance()->FindAllMeshesByObjectType("cow");
//
//    for (int i = 0; i < listOfCows.size(); i++)
//    {
//        sPhysicsProperties* cowPhysics = new sPhysicsProperties();
//        cowPhysics->shapeType = sPhysicsProperties::SPHERE;
//        cowPhysics->setShape(new sPhysicsProperties::sSphere(1.0f));
//        cowPhysics->inverse_mass = 0.0f;
//        cowPhysics->setRotationFromEuler(listOfCows[i]->drawOrientation);
//        cowPhysics->position = listOfCows[i]->drawPosition;
//        cowPhysics->friendlyName = "cow";
//        cowPhysics->objectType = "cow";
//        ::g_vec_pPhysicalProps.push_back(cowPhysics);
//    }
//
//    std::vector<cMesh*> listOfLions = cGameManager::getGmInstance()->FindAllMeshesByObjectType("lion");
//
//    for (int i = 0; i < listOfLions.size(); i++)
//    {
//        sPhysicsProperties* lionPhysics = new sPhysicsProperties();
//        lionPhysics->shapeType = sPhysicsProperties::SPHERE;
//        lionPhysics->setShape(new sPhysicsProperties::sSphere(1.0f));
//        lionPhysics->inverse_mass = 0.0f;
//        lionPhysics->setRotationFromEuler(listOfLions[i]->drawOrientation);
//        lionPhysics->position = listOfLions[i]->drawPosition;
//        lionPhysics->friendlyName = "lion";
//        lionPhysics->objectType = "lion";
//        ::g_vec_pPhysicalProps.push_back(lionPhysics);
//    }
//
//    return true;
//}