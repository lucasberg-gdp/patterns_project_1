...
void cCamera::MoveToDirection(glm::vec3 direction)
{
	...
	//m_cameraPosition += m_cameraOrientation * LEFT_VECTOR * m_cameraSpeed * leftDirection;
	//m_cameraPosition += m_cameraOrientation * FORWARD_VECTOR * m_cameraSpeed * forwardDirection;
	//m_cameraPhysics->position = m_cameraPosition;
...
void cCamera::Start()
{
	cMesh* cameraMesh = g_currentScene->GetMeshByFriendlyName("maincamera");
...
{
	this->SetPosition(m_cameraPhysics->position);
