...
glm::vec4 cColor::GetRandomColor()
{
	const float r = MathUtils().GetRandomFloat(0.0f, 1.0f);
	const float g = MathUtils().GetRandomFloat(0.0f, 1.0f);
	const float b = MathUtils().GetRandomFloat(0.0f, 1.0f);
	const float a = MathUtils().GetRandomFloat(0.0f, 1.0f);
